...
export default function project(state = initialState, action) {
    switch (action.type) {
        ...
        case projectActionTypes.PROJECT_TASK_CREATE_ERROR:
            return { ...state }
        case projectActionTypes.PROJECT_TASK_UPDATE_REQUEST:
            return { ...state }
        case projectActionTypes.PROJECT_TASK_UPDATE_SUCCESS:
            return { ...state }
        case projectActionTypes.PROJECT_TASK_UPDATE_ERROR:
            return { ...state }
        case projectActionTypes.PROJECT_TASK_REMOVE_REQUEST:
            return { ...state }
        case projectActionTypes.PROJECT_TASK_REMOVE_SUCCESS:
            return { ...state }
        case projectActionTypes.PROJECT_TASK_REMOVE_ERROR:
            return { ...state }
